    ...
    return (
        <div className="loader-overlay">
            <div className="lego-loader">
                ...
                <svg className="pl" viewBox="0 0 420 420" width="420px" height="420px" role="img" aria-label="Stack of four LEGO bricks jumping left one stud at a time, leaving one brick behind each jump so that it forms stairs. Then the reverse happens.">
                    <defs>
                        <symbol id="brick">
